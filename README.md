...
- **Порядок показа**: Запустить одновременно сервера из 4ой и 5ой лабораторных на разных сокетах. Открыть вкладку `Network`, выбрать `xhr`, выполнить фильтрацию в приложении, показать параметр в заголовке запроса в `Network`. добавить в `Postman` новую запись, показать что она появилась в приложении, указать название этой записи в фильтрации
